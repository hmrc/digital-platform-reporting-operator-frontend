...
case object HasInternationalTaxIdentifierPage extends UpdateQuestionPage[Boolean] {
    ...
    answers.get(this).map {
      case true =>
        answers.get(InternationalTaxIdentifierPage)
          ...
          .getOrElse(routes.InternationalTaxIdentifierController.onPageLoad(operatorId))
