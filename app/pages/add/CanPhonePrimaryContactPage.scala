...
case object CanPhonePrimaryContactPage extends AddQuestionPage[Boolean] {
  ...
  override protected def nextPageCheckMode(answers: UserAnswers): Call =
    answers.get(this).map {
      case true =>
        ...
        .getOrElse(routes.PrimaryContactPhoneNumberController.onPageLoad(CheckMode))
  ...
  override def route(mode: Mode): Call = routes.CanPhonePrimaryContactController.onPageLoad(mode)
}
