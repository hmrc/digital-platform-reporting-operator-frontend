...
case object HasSecondaryContactPage extends AddQuestionPage[Boolean] {
  ...
  override protected def nextPageCheckMode(answers: UserAnswers): Call =
    answers.get(this).map {
      case true =>
        ...
        .getOrElse(routes.SecondaryContactNameController.onPageLoad(CheckMode))
  ...
  override def cleanup(value: Option[Boolean], userAnswers: UserAnswers): Try[UserAnswers] =
    if (value.contains(false)) {
      userAnswers
        ...
        .flatMap(_.remove(SecondaryContactEmailPage))
  ...
  override def route(mode: Mode): Call = routes.HasSecondaryContactController.onPageLoad(mode)
}
