...
case object HasTradingNamePage extends AddQuestionPage[Boolean] {
  ...
  override protected def nextPageNormalMode(answers: UserAnswers): Call =
    answers.get(this).map {
      ...
      case false => routes.UkTaxIdentifiersController.onPageLoad(NormalMode)
  ...
  override def route(mode: Mode): Call = routes.HasTradingNameController.onPageLoad(mode)
}
