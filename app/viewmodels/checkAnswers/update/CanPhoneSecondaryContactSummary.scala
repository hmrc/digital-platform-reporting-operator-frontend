...
import pages.update.{CanPhoneSecondaryContactPage, SecondaryContactNamePage}
    ...
    for {
      ...
      contactName <- answers.get(SecondaryContactNamePage)
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.CanPhoneSecondaryContactController.onPageLoad(operatorId).url)
