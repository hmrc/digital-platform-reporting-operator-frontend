...
import pages.update.{PrimaryContactNamePage, PrimaryContactPhoneNumberPage}
    ...
    for {
      ...
      contactName <- answers.get(PrimaryContactNamePage)
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.PrimaryContactPhoneNumberController.onPageLoad(operatorId).url)
