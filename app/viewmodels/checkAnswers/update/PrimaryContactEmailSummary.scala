...
import pages.update.{PrimaryContactEmailPage, PrimaryContactNamePage}
    ...
    for {
      ...
      contactName <- answers.get(PrimaryContactNamePage)
        ...
        SummaryListRowViewModel(
          ...
          actions = Seq(
            ActionItemViewModel("site.change", routes.PrimaryContactEmailController.onPageLoad(operatorId).url)
