  ...
  ".nextPage" - {
    ...
    "must go to Check Answers" - {
      ...
      "when the answer is no" in {
        ...
        HasInternationalTaxIdentifierPage.nextPage(operatorId, answers) mustEqual routes.CheckYourAnswersController.onPageLoad(operatorId)
      }
    ...
    "must go to International Tax Identifier when the answer is ues and International Tax Identifier has not been answered" in {
      ...
      HasInternationalTaxIdentifierPage.nextPage(operatorId, answers) mustEqual routes.InternationalTaxIdentifierController.onPageLoad(operatorId)
    }
  }
