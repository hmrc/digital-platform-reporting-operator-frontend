  ...
  ".nextPage" - {
    ...
    "must go to Check Answers" - {
      ...
      "when the answer is no" in {
        ...
        HasTradingNamePage.nextPage(operatorId, answers) mustEqual routes.CheckYourAnswersController.onPageLoad(operatorId)
      }
    ...
    "must go to Trading Name when the answer is yes and Trading Name has not been answered" in {
      ...
      HasTradingNamePage.nextPage(operatorId, answers) mustEqual routes.TradingNameController.onPageLoad(operatorId)
    }
  }
