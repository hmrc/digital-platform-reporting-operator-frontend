  ...
  ".nextPage" - {
    ...
    "in Normal Mode" - {
      ...
      "must go to Tax Resident in UK when the answer is yes" in {
        ...
        HasTaxIdentifierPage.nextPage(NormalMode, answers) mustEqual routes.TaxResidentInUkController.onPageLoad(NormalMode)
      }
      ...
      "must go to Registered in UK when the answer is no" in {
        ...
        HasTaxIdentifierPage.nextPage(NormalMode, answers) mustEqual routes.RegisteredInUkController.onPageLoad(NormalMode)
      }
    }
    ...
    "in Check Mode" - {
      ...
      "must go to Check Answers" - {
        ...
        "when the answer is no" in {
          ...
          val answers = emptyAnswers.set(HasTaxIdentifierPage, false).success.value
          HasTaxIdentifierPage.nextPage(CheckMode, answers) mustEqual routes.CheckYourAnswersController.onPageLoad()
        }
      ...
      "must go to Tax Resident in UK when the answer is yes and UK Tax Identifiers has not been answered" in {

        val answers = emptyAnswers.set(HasTaxIdentifierPage, true).success.value
        HasTaxIdentifierPage.nextPage(CheckMode, answers) mustEqual routes.TaxResidentInUkController.onPageLoad(CheckMode)
      }
    }
  }
