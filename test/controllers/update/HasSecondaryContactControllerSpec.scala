...
import forms.update.HasSecondaryContactFormProvider
  ...
  "HasSecondaryContact Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual HasSecondaryContactPage.nextPage(operatorId, expectedAnswers).url
      }
    }
