...
import views.html.update.SecondaryContactNameView
...
class SecondaryContactNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val secondaryContactNameRoute = routes.SecondaryContactNameController.onPageLoad(operatorId).url
  ...
  "SecondaryContactName Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual SecondaryContactNamePage.nextPage(operatorId, emptyUserAnswers).url
      }
    }
