...
class BusinessNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  private lazy val businessNameRoute = routes.BusinessNameController.onPageLoad(operatorId).url
  ...
  "BusinessName Controller" - {
    ...
    "must redirect to the next page when valid data is submitted" in {
      ...
      running(application) {
        ...
        redirectLocation(result).value mustEqual BusinessNamePage.nextPage(operatorId, emptyUserAnswers).url
      }
    }
