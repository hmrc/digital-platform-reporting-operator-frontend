...
import pages.add.HasInternationalTaxIdentifierPage
import play.api.inject.bind
import play.api.test.FakeRequest
import play.api.test.Helpers._
import repositories.SessionRepository
import views.html.add.HasInternationalTaxIdentifierView
...
class HasInternationalTaxIdentifierControllerSpec extends SpecBase with MockitoSugar {
  ...
  "HasInternationalTaxIdentifier Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = emptyUserAnswers.set(HasInternationalTaxIdentifierPage, true).success.value
